import{_ as s,o as n,c as a,O as l}from"./chunks/framework.4703df87.js";const E=JSON.parse('{"title":"Brew","description":"","frontmatter":{},"headers":[],"relativePath":"tools/brew.md"}'),p={name:"tools/brew.md"},o=l(`<h1 id="brew" tabindex="-1">Brew <a class="header-anchor" href="#brew" aria-label="Permalink to &quot;Brew&quot;">​</a></h1><h2 id="命令" tabindex="-1">命令 <a class="header-anchor" href="#命令" aria-label="Permalink to &quot;命令&quot;">​</a></h2><div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 查看版本</span></span>
